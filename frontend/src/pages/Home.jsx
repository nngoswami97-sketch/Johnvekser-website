      ...
      <Container className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        >
          ...
          <h1 className="mt-6 font-display font-extrabold tracking-[-0.04em] leading-[0.98] balance text-[clamp(2.4rem,6.2vw,5.2rem)]">
            Funding ideas in <Highlight>diverse regions.</Highlight>
          </h1>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4">
            <PillButton testid="hero-cta-empower">Empower your community</PillButton>
            <a
...
/* ================================================================ */
/*  Section 4 — Shape (large type)                                  */
/* ================================================================ */

const Shape = () => {
  const tags = ["Capital", "Co-founders", "Accelerators", "Traction", "Teams", "Products", "& more"];
  return (
    <section data-testid="shape-section" className="py-28 lg:py-44 bg-white relative overflow-hidden">
...
const PILLARS = [
  {
    ...
    icon: Users,
    cta: "Unite",
    body: "We're committed to cultivating robust leadership for the evolving business landscape. Through expert-led training, we develop leaders who can confidently inspire and guide.",
  ...
  },
  {
    ...
    icon: Compass,
    cta: "Discover",
    body: "We offer platforms for founders to learn from experienced leaders. Our resources, like educational programs and advanced facilities, enable entrepreneurs to make significant decisions.",
    img: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?crop=entropy&cs=srgb&fm=jpg&q=85&w=900",
  ...
  },
  {
    ...
    icon: TrendingUp,
    cta: "Elevate",
    body: "Our commitment extends beyond fostering leadership and aiding decision-making. We provide the funding and tech tools to boost growth, turning potential into measurable business success.",
    img: "https://images.unsplash.com/photo-1559136555-9303baea8ebd?crop=entropy&cs=srgb&fm=jpg&q=85&w=900",
...
const Pillars = () => (
  <section data-testid="pillars-section" className="py-28 lg:py-40 bg-neutral-50 border-y border-black/5">
    <Container>
      <div className="max-w-2xl mb-20">
        <Overline>05 — 07 The Pillars</Overline>
        <h2 className="mt-6 font-display font-extrabold tracking-[-0.035em] leading-[1.05] balance text-[clamp(1.9rem,4.8vw,3.6rem)]">
          Three forces that turn <Highlight>potential into outcome.</Highlight>
        </h2>
      </div>
        ...
        {PILLARS.map((p, i) => {
          ...
          return (
            ...
            >
              ...
              <h3 className="mt-3 font-display font-bold tracking-tight text-3xl">{p.title}</h3>
...
const Global = () => (
  <section id="global" data-testid="global-section" className="relative py-28 lg:py-44 bg-white overflow-hidden">
    ...
    <Container className="relative grid grid-cols-1 lg:grid-cols-12 gap-14 items-center">
          ...
          {OFFICES.map((o, i) => (
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                <span className="w-1.5 h-1.5 rounded-full bg-black" />
                <span className="text-[10px] uppercase tracking-[0.2em] text-neutral-500">{o.role}</span>
              </div>
              <div className="font-display font-bold text-[18px] tracking-tight">{o.city}</div>
            </motion.div>
          ))}
        </div>
        <div className="mt-12">
      ...
      >
        <div className="relative aspect-square max-w-md mx-auto">
          <motion.div animate={{ rotate: 360 }} transition={{ duration: 60, ease: "linear", repeat: Infinity }} className="absolute inset-0 rounded-full border border-dashed border-black/15" />
          <motion.div animate={{ rotate: -360 }} transition={{ duration: 90, ease: "linear", repeat: Infinity }} className="absolute inset-6 rounded-full border border-black/10" />
          <motion.div animate={{ rotate: 360 }} transition={{ duration: 45, ease: "linear", repeat: Infinity }} className="absolute inset-12 rounded-full border border-dashed border-black/20" />
          ...
          {[
            ...
            >
              <span className="absolute inset-0 w-3 h-3 -translate-x-1/2 -translate-y-1/2 rounded-full bg-black/30 animate-ping" />
...
const Featured = () => (
  <section id="press" data-testid="featured-section" className="py-24 lg:py-32 bg-white border-y border-black/5 overflow-hidden">
    <Container className="text-center mb-12">
      <Overline>09 — Trust & Press</Overline>
      <h2 className="mt-6 font-display font-bold tracking-tight text-3xl lg:text-5xl">Featured in</h2>
    ...
    <Container className="mt-16">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {[
          { q: "A new lens on impact-driven entrepreneurship.", src: "Forbes" },
          { q: "Among the most ambitious global founder programs.", src: "Inc. 5000" },
          { q: "Capital and culture meet — for the communities that need it.", src: "HuffPost" },
        ].map((c, i) => (
          <motion.figure
            key={i}
            initial="hidden"
          ...
          >
            ...
            <figcaption className="mt-6 text-[12px] uppercase tracking-[0.22em] text-neutral-500">— {c.src}</figcaption>
          </motion.figure>
        ))}
      </div>
    </Container>
...
const FinalCTA = () => (
  <section id="cta" data-testid="final-cta-section" className="relative py-32 lg:py-44 bg-white overflow-hidden">
...
export default function Home() {
  return (
    <div data-testid="home-root" className="bg-white text-black overflow-x-hidden">
      <ScrollProgress />
      <Navbar />
      <main className="pt-0">
        <Hero />
